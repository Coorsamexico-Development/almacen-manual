...
import TarimasEntradaModal from './Partials/TarimasEntradaModal.vue';
...
const entrada = ref({ id: -1 });
const showingTarimasEntradas = ref(false);
...
const showTarimasEntradas = (entradaSelect) => {
    entrada.value = entradaSelect;
    showingTarimasEntradas.value = true;
}
        ...
        <div class="py-6">
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="overflow-hidden bg-white shadow-xl sm:rounded-lg">
                            ...
                            <tr class="text-center">
                                ...
                                <th scope="col"
                                    ...
                                    <span class="" @click="sort('producto')">
                                        PRODUCTO
                                        <template v-if="params.field === 'producto'">
                                            <svg v-if="params.direction === 'asc'" xmlns="http://www.w3.org/2000/svg"
                                                class="inline w-4 h-4" viewBox="0 0 20 20" fill="currentColor">
                                                <path
                                                    d="M3 3a1 1 0 000 2h11a1 1 0 100-2H3zM3 7a1 1 0 000 2h5a1 1 0 000-2H3zM3 11a1 1 0 100 2h4a1 1 0 100-2H3zM13 16a1 1 0 102 0v-5.586l1.293 1.293a1 1 0 001.414-1.414l-3-3a1 1 0 00-1.414 0l-3 3a1 1 0 101.414 1.414L13 10.414V16z" />
                                ...
                                <th scope="col"
                                    ...
                                    <span class="" @click="sort('canitdad_disponible')">
                                        CANTIDAD DISPONIBLE
                                        <template v-if="params.field === 'canitdad_disponible'">
                                            <svg v-if="params.direction === 'asc'" xmlns="http://www.w3.org/2000/svg"
                                                class="inline w-4 h-4" viewBox="0 0 20 20" fill="currentColor">
                                                <path
                                                    d="M3 3a1 1 0 000 2h11a1 1 0 100-2H3zM3 7a1 1 0 000 2h5a1 1 0 000-2H3zM3 11a1 1 0 100 2h4a1 1 0 100-2H3zM13 16a1 1 0 102 0v-5.586l1.293 1.293a1 1 0 001.414-1.414l-3-3a1 1 0 00-1.414 0l-3 3a1 1 0 101.414 1.414L13 10.414V16z" />
                            ...
                            <tr v-for="(entrada, index) in entradas.data" :key="index" class="text-sm text-gray-500">
                                ...
                                <td class="px-2 py-1 whitespace-nowrap">
                                    <span class="px-2 py-1 text-white bg-yellow-600 rounded">
                                        ...
                                        {{ entrada.canitdad_disponible }}
                                    </span>
                                </td>
                                <td class="px-2 py-1 whitespace-nowrap">
                                    <SecondaryButton @click="showTarimasEntradas(entrada)">
                    ...
                    <Pagination :pagination="entradas" />
                </div>
            </div>
        </div>
        <TarimasEntradaModal :show="showingTarimasEntradas" :entrada="entrada"
            @close="showingTarimasEntradas = false" />
    </AppLayout>
</template>
